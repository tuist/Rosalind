...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/tuist/FileSystem.git", .upToNextMajor(from: "0.15.10")),
        ...
        .package(url: "https://github.com/apple/swift-protobuf.git", .upToNextMajor(from: "1.36.0")),
    ],
    targets: [
        .target(
            name: "Rosalind",
