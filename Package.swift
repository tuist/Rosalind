...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/tuist/FileSystem.git", .upToNextMajor(from: "0.10.3")),
        .package(url: "https://github.com/tuist/Command.git", .upToNextMajor(from: "0.13.0")),
        .package(
            url: "https://github.com/pointfreeco/swift-snapshot-testing",
            .upToNextMajor(from: "1.18.4")
        ),
        ...
        .package(url: "https://github.com/p-x9/MachOKit", .upToNextMajor(from: "0.34.0")),
        .package(url: "https://github.com/Kolos65/Mockable", .upToNextMajor(from: "0.3.2")),
    ],
    targets: [
        .target(
            name: "Rosalind",
