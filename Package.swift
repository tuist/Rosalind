...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/tuist/FileSystem.git", .upToNextMajor(from: "0.15.28")),
        ...
        .package(url: "https://github.com/apple/swift-crypto.git", .upToNextMajor(from: "4.3.1")),
        .package(url: "https://github.com/p-x9/MachOKit", .upToNextMajor(from: "0.48.0")),
        .package(url: "https://github.com/Kolos65/Mockable", .upToNextMajor(from: "0.6.2")),
        .package(url: "https://github.com/apple/swift-protobuf.git", .upToNextMajor(from: "1.36.1")),
    ],
    targets: [
        .target(
            name: "Rosalind",
