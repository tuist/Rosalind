...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/tuist/FileSystem.git", .upToNextMajor(from: "0.19.0")),
        ...
        .package(url: "https://github.com/apple/swift-crypto.git", .upToNextMajor(from: "4.5.2")),
