...
> [!IMPORTANT]
> Rosalind has been merged into the [Tuist repository](https://github.com/tuist/tuist). Please use the version in `tuist/tuist`; this standalone repository is archived and no longer maintained.
