...
### Details
#### <!-- 1 -->🐛 Bug Fixes
- Apply a reference-device split filter to AAB sizes by @pepicrft in [#539](https://github.com/tuist/Rosalind/pull/539)

## [0.8.1] - 2026-09-15
### Details
#### <!-- 4 -->⚡ Performance
- Stream-analyze Android bundles from the archive without extracting by @pepicrft in [#538](https://github.com/tuist/Rosalind/pull/538)

## [0.8.0] - 2026-09-15
### Details
#### <!-- 0 -->🚀 Features
- Emit diagnostic logs across the Android analysis pipeline by @pepicrft
...
### Details
#### <!-- 1 -->🐛 Bug Fixes
- Unzip an .aab exactly once during analysis by @pepicrft

## [0.7.97] - 2026-09-09
### Details
#### <!-- 1 -->🐛 Bug Fixes
- Bump ZIPFoundation to 0.9.22 to pick up Linux inflate loop fix by @pepicrft
...
[0.8.2]: https://github.com/tuist/Rosalind/compare/0.8.1..0.8.2
[0.8.1]: https://github.com/tuist/Rosalind/compare/0.8.0..0.8.1
[0.8.0]: https://github.com/tuist/Rosalind/compare/0.7.99..0.8.0
